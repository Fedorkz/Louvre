...
class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.ViewHolder> {
    ...
    @Override
    public AlbumsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, @ViewType int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(AlbumsAdapter.ViewHolder holder, int position, List<Object> payloads) {
